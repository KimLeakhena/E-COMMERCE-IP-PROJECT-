      ...
      <div class="w-full flex justify-between items-center">
        ...
        <ul class="flex items-center gap-6 text-white text-2xl pr-2">
          <RouterLink to="/homepage">
            <li
              class="cursor-pointer hover:bg-gray w-full flex justify-center items-center"
            >
              <a href="">Home</a>
            </li>
          </RouterLink>
          ...
          <RouterLink to="/about">
            <li class="cursor-pointer w-full flex justify-center items-center">
              <a href="">Contact</a>
            </li>
          </RouterLink>
          <RouterLink to="/Cart">
          ...
          <li
            class="h-30 w-full checker-bg flex items-center justify-center p-2 text-blue-500"
          >
            <div
              type="button"
              data-dropdown-toggle="userDropdown"
              data-dropdown-placement="bottom-start"
              class="my-4 w-14 h-14 cursor-pointer bg-gray-100 rounded-full bg-cover bg-center"
            >
              <img
                id="avatarButton"
                type="button"
    ...
    <main>
      ...
      <div class="slide-container">
        <div class="img-wrapper">
          <img
            src="https://www.weverseshop.io/_next/image?url=https%3A%2F%2Fcdn-contents.weverseshop.io%2Fpublic%2Fshop%2Fb6c3e0cfdab92e9994afbffd15b93374.png&w=720&q=95"
            class="active"
          />
          <img
            src="https://www.weverseshop.io/_next/image?url=https%3A%2F%2Fcdn-contents.weverseshop.io%2Fpublic%2Fshop%2F362a617abc2bcea0e6c6b968f18d88c4.png&w=720&q=95"
          />
          <img
            src="https://www.weverseshop.io/_next/image?url=https%3A%2F%2Fcdn-contents.weverseshop.io%2Fpublic%2Fshop%2Fd106107f5bb52166992da89d05d52a6e.png&w=720&q=95"
          />
          <img
            src="https://www.weverseshop.io/_next/image?url=https%3A%2F%2Fcdn-contents.weverseshop.io%2Fpublic%2Fshop%2F0bbd0bb656292b2e8ddde7f70a62f443.png&w=720&q=95"
          />
        </div>
      ...
      <!-- discount -->
      <div class="p-6 py-12 bg-[#c7d2fe] my-6">
        <div class="container mx-auto">
          <div class="flex flex-col lg:flex-row items-center justify-between">
            ...
            <a
              ...
              class="px-5 mt-4 lg:mt-0 py-3 rounded-md border block bg-[#826B9F] hover:bg-[#B0A3C0] text-white dark:border-gray-400"
              >Shop Now</a
            >
          </div>
        </div>
      ...
      <section class="p-4 lg:p-8 dark:bg-gray-800 dark:text-gray-100">
        <div class="container mx-auto space-y-12">
          ...
          >
            <img
              src="https://pbs.twimg.com/media/EWVS1vpU8AE8LAg.jpg"
              alt=""
              class="h-80 dark:bg-gray-500 aspect-video"
            />
            <div
              class="flex flex-col justify-center flex-1 p-6 dark:bg-gray-900"
            >
              ...
              <p class="my-6 dark:text-gray-400">
                ...
                Seventeen.It was released on September 16, 2019, through Pledis
                Entertainment.The album spawned two singles, "Hit" was released
                as the album's lead single on August 5, 2019, followed by the
                title track, "Fear", on the release date of the album.
              </p>
          ...
          <div
            class="my-4 mx-auto w-5/6 jutify-center h-[70px] bg-[#826B9F] p-4 rounded-2xl"
          >
            <h1 class="text-center font-serif text-2xl text-white">
              New Release
            </h1>
          </div>
          ...
          >
            <img
              src="https://kpoplat.com/wp-content/uploads/2021/06/treasure-lighstick-sold-out-kpoplat-750x450.png"
              alt=""
              class="h-80 dark:bg-gray-500 aspect-video"
            />
            <div
            ...
            >
              ...
              <p class="my-6 dark:text-gray-400">
                The concept behind the light stick’s design is a “treasure box,”
                which is similar to the name of the survival show “YG Treasure
                Box” through which the group was created. At the top of the
                light stick is a jewel shape that symbolizes TREASURE and their
                fans TREASURE MAKER.
              </p>
          ...
          <div class="m-auto px-6 py-40">
            <div
              class="flex flex-col md:flex-row items-center justify-between relative w-100 h-auto md:h-64 bg-100 shadow-2xl rounded-lg p-8"
            >
              <div class="w-8/12 text-2xl">
                ...
                <span class="flex"
                  ...
                  Above the top is the sky, above that is the universe, and even
                  above that there’s going to be something else. I always want
                  to be growing, higher than the sky and the universe "</span
                >
              </div>
              <div
                class="relative shadow-md font-medium my-5 py-2 px-4 text-white cursor-pointer bg-yellow-600 hover:bg-yellow-500 rounded text-lg text-center w-48"
              >
                <span
                  class="absolute h-3 w-3 right-0 top-0 animate-ping inline-flex rounded-full h-3 w-3 bg-yellow-600"
                >
                </span>
                iKON’s Bobby
              </div>
          ...
          >
            <img
              src="https://www.weverseshop.io/_next/image?url=https%3A%2F%2Fcdn-contents.weverseshop.io%2Fpublic%2Fshop%2F16dd9f0eac95eddb9d067035a45cea50.png&w=720&q=95"
              alt=""
              class="h-80 dark:bg-gray-500 aspect-video"
            />
            <div
            ...
            >
              ...
              <p class="my-6 dark:text-gray-400">
                TREASURE has started pre-orders for their second full-length
                album, REBOOT, with a digipack and KiT versions. The digipack
                version has been prepared in various configurations, including a
                20-page booklet for each member, a folding poster, a selfie
                photo card, a rare selfie photo card, and a QR lyric card.
              </p>
              <button type="button" class="self-start">Buy now</button>
            </div>
          </div>
        ...
        <div class="grid justify-center lg:justify-between">
          ...
          <div class="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            <a
              ...
              href="#"
              title="Email"
              class="flex items-center justify-center w-10 h-10 rounded-full bg-[#826B9F] hover:bg-[#B0A3C0] duration-150 text-gray-50"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
...
import price from "../libs/apis/price";
