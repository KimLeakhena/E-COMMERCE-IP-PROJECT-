          ...
          <div>
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-12">
                <label
                  for=""
                  class="text-xs font-semibold flex justify-between px-1"
                  >Password
                  <a
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button
                  type="submit"
                  class="block w-full max-w-xs mx-auto bg-[#826B9F] hover:bg-[#B0A3C0] focus:bg-[#B0A3C0] text-white rounded-lg px-3 py-3 font-semibold"
                >
                  Log In
                </button>
              </div>
...
export default {
  ...
  methods: {
    async onSubmit(e) {
      e.preventDefault();
      const res = await fetch("https://chocobebe.xyz/auth/login", {
        method: "POST",
