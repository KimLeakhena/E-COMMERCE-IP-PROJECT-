                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            <label for="" class="text-xs font-semibold flex justify-between px-1">Password
                            ...
                            <div class="flex">
                                ...
                                <input v-model="password" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" required>
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                                ...
                                <button type="submit" class="block w-full max-w-xs mx-auto bg-[#826B9F] hover:bg-[#B0A3C0] focus:bg-[#B0A3C0] text-white rounded-lg px-3 py-3 font-semibold">Log In</button>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            ...
                            <RouterLink :to="{name:'auth/signup'}">
                                <a class="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</a>
                            </Routerlink>
                        </div>
                </div>
            </div>
